...
public class SimpleTextEditor {
	...
	public static void main(String[] args) throws IOException {
		...
		// Using scanner in this case will make the job to run slow because scanner uses
		// regex to validate type of input. Hence using BufferedReader makes the prpgram
		// run faster.
//		Scanner scan = new Scanner(System.in);
		BufferedReader scan = new BufferedReader(new InputStreamReader(System.in));
		STE ste = new STE();

		int numElements = Integer.parseInt(scan.readLine());
//		scan.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");
