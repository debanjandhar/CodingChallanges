...
class TestClass {
	private static String getSmalledtWithOpOne(String s1, String s2) {
	...
	private static String getSmalledtWithOpTwoAndOne(String s1, String s2, int[] pairs) {
		...
		String smallest = getSmalledtWithOpOne(s1, s2);
	...
	public static void main(String args[]) throws Exception {
		...
		for (int i = 0; i < numTestCase; i++) {
			...
			String ret1 = getSmalledtWithOpOne(s1, s2);
			String ret2 = getSmalledtWithOpTwoAndOne(s1, s2, pairs);
